...
/*
El modulo regs4 es un modulo que simula un registro que puede
almacenar datos de hasta 4 bits de tamaño, en este caso datos del tipo
sc_unit<4>
...
class regs4 : public sc_module{
	public:
		...
		sc_in < sc_uint<4> > data_in; //la data que entra al modulo, del TIPO SC_UNIT<4>, que es nos permite almacenar numeros de hasta 8 bits
		sc_out < sc_uint<4> > data_out; //la data que sale del modulo, del TIPO SC_UNIT<4>, que es nos permite almacenar numeros de hasta 4 bits

		sc_uint<4> data; //la que ESTA en el modulo actualmente, es decir, la que saldra por data_out
